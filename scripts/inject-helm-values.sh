...
# Optional: HELM_DATA_VERSION, HELM_PRESENTATION_VERSION, HELM_GATEWAY_VERSION (default 0.1.3, 0.1.4 for gateway)
...
HELM_GATEWAY_VERSION="${HELM_GATEWAY_VERSION:-0.1.4}"
